export default [
  {
    ...
    subCategories: [
      ...
      {
        value: 'general_knowledge_facts_figures',
        text: 'Facts & Figures',
      },
      {
  ...
  },
  {
    ...
    subCategories: [
      ...
      {
        value: 'tv_shows_cartoons_animation',
  ...
  },
  {
    ...
    subCategories: [
      ...
      {
        value: 'music_award_winners',
        text: 'Award Winners (Grammys, etc.)',
      },
    ],
  },
  {
    ...
    subCategories: [
      ...
      {
        value: 'books_literature_classic_novels',
        text: 'Classic Novels',
      },
      {
        value: 'books_literature_modern_fiction',
        text: 'Modern Fiction',
      },
      { value: 'books_literature_poetry', text: 'Poetry' },
      {
        value: 'books_literature_childrens',
  ...
  },
  {
    ...
    subCategories: [
      ...
      {
        value: 'history_famous_figures',
        text: 'Famous Historical Figures',
      },
  ...
  },
  {
    ...
    subCategories: [
      ...
      {
        value: 'geography_countries_capitals',
        text: 'Countries & Capitals',
      },
      {
        value: 'geography_continents_oceans',
        text: 'Continents & Oceans',
      },
  ...
  },
  {
    ...
    subCategories: [
      ...
      {
        value: 'science_human_body_medicine',
        text: 'Human Body & Medicine',
      },
    ],
  },
  {
    ...
    subCategories: [
      ...
      {
        value: 'art_literature_art_movements',
        text: 'Art: Art Movements',
      },
      {
  ...
  },
  {
    ...
    subCategories: [
      ...
      {
        value: 'mythology_mythical_creatures',
  ...
  },
  {
    ...
    subCategories: [
      ...
      {
        value: 'current_events_politics',
        text: 'Politics (Recent Events)',
      },
      {
